...
export default async function Home() {
    ...
    return (
        <>
            <HorizontalVideoListSection name="Continue Watching" videos={horizontalVideos} fetchMore={fetchMoreHorizontal} />
            <VerticalVideoListSection videos={verticalVideos} fetchMore={fetchMoreVertical} />
        </>
    )
}
