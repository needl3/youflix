        ...
        <div className="flex items-center gap-x-4 pb-5">
            ...
            <div className="w-full relative">
                <input
                    ...
                    className={`bg-transparent w-full mb-3 border-b transition duration-300 ${
                        activeComment ? 'border-b-black' : ''
                    } focus:outline-none`}
                    onChange={handleCommentChange}
                />
                {activeComment && (
                    <div className="flex justify-between items-center fr transition duration-1000">
                        <div className="hover:bg-slate-200 p-2 rounded-full cursor-pointer">
                            <Emoticon />
                        </div>
                        <div className="flex gap-x-2">
                            <button
                                className="px-3 py-1 hover:bg-slate-200 rounded-full transition duration-300"
                            ...
                            <button
                                className={`rounded-full px-3 py-2 transition duration-300 ${
                                    commentDetail.content.length > 0
                                        ? 'bg-blue-300'
