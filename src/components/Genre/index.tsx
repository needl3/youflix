        ...
        <>
            {
                ...
                scrollStatus !== -1 && (
                    <button
                        className="bg-white hover:bg-slate-200 transition duration-300 sticky left-0 rounded-full self-cente p-2 rotate-90"
                        onClick={moveLeft}
                    >
                        <RightSign />
                    </button>
            ...
            <ul className="flex gap-x-2 shrink-0">
                {genre.map(g => (
                    <li
                        className={`text-sm px-3 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 transition duration-300 ${
                            selected === g ? 'bg-slate-400' : ''
                        } cursor-pointer`}
                        onClick={() => {
                            setSelected(g)
                            dispatch(setGenre(g))
            ...
            </ul>
            {
                ...
                scrollStatus !== 1 && (
                    <button
                        className="bg-white hover:bg-slate-200 transition duration-300 sticky right-0 rounded-full self-cente p-2 -rotate-90"
                        onClick={moveRight}
                    >
                        <RightSign />
                    </button>
