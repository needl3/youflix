...
const notifsArr: NotificationInterface[] = [
    {
        title: 'First title',
        uploader:
            'https://yt3.ggpht.com/ytc/AOPolaT-bsfkO28q6yOROoasYT4tTvUjchqJ1GE6GGwJeA=s48-c-k-c0x00ffffff-no-rj',
    },
    {
        title: 'Second title',
        uploader:
    ...
    return (
        <>
            <div className="relative">
                <div
                    className="p-2 hover:bg-gray-200 hover:cursor-pointer rounded-full w-fit"
